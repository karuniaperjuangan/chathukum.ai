    ...
    return (
        <div className=" w-screen h-screen flex flex-col bg-ch-almost-white">
            ...
            <div className="flex flex-col items-center justify-center w-fit h-fit space-y-4 shadow-lg shadow-gray-300 py-8 px-8 rounded-lg bg-white">
                ...
                <input type="username" placeholder="Username" className="p-2 border rounded" onChange={(e) =>{setUsername(e.target.value)}} />
                <input type="password" placeholder="Password" className="p-2 border rounded" onChange={(e)=>{setPassword(e.target.value)}}/>
                <button className=" w-full bg-ch-coral hover:bg-ch-brick-red text-white py-2 px-6 rounded" onClick={Login}>Login</button>
